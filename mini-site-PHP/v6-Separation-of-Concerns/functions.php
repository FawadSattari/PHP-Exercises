...
//Check if session already contains a language
if(!isset($_SESSION["lang"])){
  //IF NOT,DEFINE A DEFAULT LANGUAGE
  $_SESSION["lang"]="en";
}

//CHECK IF USER WNATS ANOTHER LANGUAGE
if (isset($_GET["lang"])){
//DEFINE NEW LANGUAGE IN SESSION
...
function site_data() {
  ...
  //GET THE RIGHT FILE DEPENDING ON USER 'S LANGUAGE

  $json_file = 'site_data_'.$_SESSION['lang'].'.json';
...
function content($params = []) {
  ...
  //PREPARE FILE PATH
  $html_file        = $params['get_page'] . '_' . $_SESSION["lang"] . '.html'; 
...
//Language chanfe function with one click in the same page ----
function lang($lang_str = '', $get_page) {

  return '?page='.$get_page.'&lang='.$lang_str;
